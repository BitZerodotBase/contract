...
contract BitStakeDao {
    ...
    // A proposal is only valid for 7 days
...
function createProposal(string memory _description) external {
    require(bitStake.getStaked(msg.sender) >= 100000 * 10**18, "Must have at least 100000 BTZ staked");
    ...
    function vote(uint256 _proposalId, VoteOption _voteOption) external {
        ...
        require(stakedAmount > 0, "Must be a staker to vote");
